...
if !COMPILE! equ 1 (
    ...
    msbuild "BULLET_PHYSICS.sln" /p:configuration=Debug /p:Platform=x64 /maxcpucount
    msbuild "BULLET_PHYSICS.sln" /p:configuration=Release /p:Platform=x64 /maxcpucount

...
if !COMPILE! equ 1 (
    ...
    cmake -A %PLATFORM% -DOGRE_BUILD_COMPONENT_BULLET:BOOL=0 -DOGRE_BUILD_COMPONENT_BITES:BOOL=0 -DOGRE_BUILD_PLUGIN_ASSIMP:BOOL=0 -DOGRE_BUILD_PLUGIN_DOT_SCENE:BOOL=0 -DOGRE_BUILD_SAMPLES:BOOL=0 -DOGRE_INSTALL_SAMPLES:BOOL=0 -DOGRE_BUILD_TOOLS:BOOL=0 -DOGRE_INSTALL_TOOLS:BOOL=0 -DOGRE_BUILD_RENDERSYSTEM_D3D11:BOOL=0 -DOGRE_BUILD_RENDERSYSTEM_GL3PLUS:BOOL=0 -DOGRE_BUILD_RENDERSYSTEM_GLES2:BOOL=0 -DOGRE_BUILD_RENDERSYSTEM_TINY:BOOL=0 -DOGRE_BUILD_RENDERSYSTEM_VULKAN:BOOL=0 %COMPILEDIR%
    ...
    echo FileSystem=./assets/mesh/ >> .\bin\release\resources.cfg
    XCOPY /y /s .\bin\release\resources.cfg %DLLFOLDERS%
